...
public class RabbitMQConfig {
     ...
     */
    @Bean
    public Binding binding_queue_media_processtask1(@Qualifier("xc_learning_finishaddchoosecourse") Queue queue, @Qualifier(EX_LEARNING_ADDCHOOSECOURSE) Exchange exchange) {
     ...
     */
    @Bean
    public Binding binding_queue_media_processtask2(@Qualifier(XC_LEARNING_ADDCHOOSECOURSE) Queue queue, @Qualifier(EX_LEARNING_ADDCHOOSECOURSE) Exchange exchange) {
